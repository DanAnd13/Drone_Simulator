...
{
    [Header("Components")]
    [SerializeField] private ExperimentMovement _movement;
    ...
    [SerializeField] private ExperimentResultBuilder _resultBuilder;
    ...
    private IEnumerator ExperimentRoutine()
    {
        ...
        ExperimentResult result = _resultBuilder.Build();
